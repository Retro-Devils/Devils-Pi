...
''${bfgylw}'(()/(  (  ( /((         (()/(    (   )  (  )\'
''${bfgylw}' /(_))))\ )\())(   ( ___ /(_))  ))\ /(( )\((_|'
''${fgylw}'('${fgred}'_'${fgylw}')) /((_|'${fgred}'_'${fgylw}'))(('${bfgylw}')\  )\___('${fgred}'_'${fgylw}'))'${fgred}'_'${fgylw}'  /((_|_))((_)_ )\'${fgred}''
''${fgred}'| _ \'${fgylw}'('${fgred}'_'${fgylw}'))'${fgred}'| |_ '${fgylw}'(('${fgred}'_'${fgylw}')(('${fgred}'_'${fgylw}')   '${fgred}'|   \'${fgylw}'('${fgred}'_'${fgylw}')) '${fgred}'_'${fgylw}')(('${fgred}'_|_)'${fgylw}' (('${fgred}'_'${fgylw}')'${fgred}''
''${fgred}'|   / -_)|  _| `_/ _ \   | |) / -_)\ V /| | (_-<'
''${fgred}'|_|_\___| \__|_| \___/   |___/\___| \_/ |_|_/__/'
        )
